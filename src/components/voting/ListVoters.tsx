...
import { ReactionId, Reaction, ProductId } from '@darkpay/dark-types/substrate/interfaces/darkdot';
...
export const ProductVoters = withMulti(
  InnerModalVoters,
  withCalls<VotersProps>(
    reactionsQueryToProp(`reactionIdsByProductId`, { paramName: 'id', propName: 'reactionIds' })
  )
);
