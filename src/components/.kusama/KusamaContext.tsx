...
import { registryTypes as DarkdotTypes, AnyAccountId } from '@darkpay/dark-types'
import { newLogger, isNum, notDef, isEmptyStr } from '@darkpay/dark-utils'
...
export const KusamaProvider = (props: KusamaProviderProps) => {
  ...
  //  _api.on('error', err => dispatch({ type: 'CONNECT_ERROR', payload: err }))
   _api.on('error', () => log.warn(`TODO : upgrade to @polkadot types > 4.4.3 for Kusama node ${endpoint}`))
