...
import { withCalls, withMulti, storefrontFollowsQueryToProp, profileFollowsQueryToProp } from '../substrate';
...
export const StorefrontFollowersModal = withMulti(
  InnerAccountsListModal,
  withCalls<Props>(
    storefrontFollowsQueryToProp('storefrontFollowers', { paramName: 'id', propName: 'accounts' })
  )
);
